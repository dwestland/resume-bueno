  ...
  return (
    <div className="mx-auto max-w-4xl mt-10 mb-6">
      ...
      <p>
        ...
        generated by our AI-powered system are provided on an{' '}
        <strong>&quot;as is&quot;</strong> basis.
      </p>

      <h3>Data Retention</h3>
      <p>
        Resume Packages and Matching Resumes may be automatically deleted after{' '}
        <strong>90 days</strong>. Users are responsible for saving and storing
        their resume materials outside of the Service if they wish to retain
        them beyond this period.
      </p>
