// Test script for Stripe webhook yearly subscription
...
// Create a sample checkout.session.completed event for yearly subscription
const createYearlySubscriptionEvent = () => {
...
const main = async () => {
  try {
    const event = createYearlySubscriptionEvent()
